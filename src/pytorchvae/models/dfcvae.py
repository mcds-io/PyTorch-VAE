...
class DFCVAE(BaseVAE):
    ...
    def extract_features(
        self, input: torch.Tensor, feature_layers: tp.List = None
    ) -> tp.List[torch.Tensor]:
        """
        Extracts the features from the pretrained model
        at the layers indicated by feature_layers.
        :param input: (torch.Tensor) [B x C x H x W]
        :param feature_layers: tp.List of string of IDs
        :return: tp.List of the extracted features
        """
