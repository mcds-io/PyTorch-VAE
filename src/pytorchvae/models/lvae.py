...
class LVAE(BaseVAE):
    ...
    def __init__(
        self, in_channels: int, latent_dims: tp.List, hidden_dims: tp.List, **kwargs
    ) -> None:
    ...
    def encode(self, input: torch.Tensor) -> tp.List[torch.Tensor]:
        ...
        :return: (torch.Tensor) tp.List of latent codes
        """
        h = input
    ...
    def decode(self, z: torch.Tensor, post_params: tp.List) -> tp.Tuple:
        """
    ...
    def compute_kl_divergence(
        self, z: torch.Tensor, q_params: tp.Tuple, p_params: tp.Tuple
    ):
    ...
    def forward(self, input: torch.Tensor, **kwargs) -> tp.List[torch.Tensor]:
