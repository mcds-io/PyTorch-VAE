...
class HVAE(BaseVAE):
    ...
    def encode_z2(self, input: torch.Tensor) -> tp.List[torch.Tensor]:
        """
    ...
    def encode_z1(self, input: torch.Tensor, z2: torch.Tensor) -> tp.List[torch.Tensor]:
